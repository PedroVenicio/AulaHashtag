...
const Player = ({ duration, randomIdFromArtist, randomId2FromArtist, audio }) => {
    ...
    useEffect(() => {
        ...
        return () => clearInterval(intervalId) //"desmonta" o componente, nesse caso para de fazer o interval, se nao ia ter varios intervalos rodando a cada vez q re renderizasse
    }, [isPlaying])
